...
public class AutoDrive extends CommandBase{ 
    ...
    public AutoDrive(Drivetrain drivetrain, Double move, Double rotate, Double value){
    ...
    public boolean isFinished(){
        return m_drivetrain.isDistanceReached(m_value);
    }

    public boolean isFinishedReverse(){
